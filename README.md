    ...
    <div class="container px-5 py-24 mx-auto flex flex-wrap">
      ...
      <div class="flex flex-wrap md:-m-2 -m-1">
        ...
        <div class="flex flex-wrap w-1/2">
          ...
          <div class="md:p-2 p-1 w-1/2">
            <img alt="gallery" class="w-full object-cover h-full object-center block" src="https://www.google.com/imgres?imgurl=https%3A%2F%2Fupload.wikimedia.org%2Fwikipedia%2Fen%2Fe%2Fe8%2FFairy_Tail_100_Years_Quest%252C_Vol_1.jpg&imgrefurl=https%3A%2F%2Fen.wikipedia.org%2Fwiki%2FFairy_Tail%3A_100_Years_Quest&tbnid=Puzy58gCmuuf4M&vet=12ahUKEwiK06LovsD4AhVWk9gFHRxJBiYQMygLegQIARBc..i&docid=1vVrgF2bpX5EkM&w=257&h=385&q=fairy%20tail%20%20500*300%20pics&ved=2ahUKEwiK06LovsD4AhVWk9gFHRxJBiYQMyg000LegQIARBc">
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
          <div class="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
            <a class="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
              ...
              <span class="ml-3 text-xl">Anime hub</span>
            </a>
            <p class="mt-2 text-sm text-gray-500">pratik online cooperation</p>
          </div>
          <div class="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
            <div class="lg:w-1/4 md:w-1/2 w-full px-4">
              <h2 class="title-font font-medium text-gray-900 tracking-widest text-sm mb-3">romance and fun</h2>
              <nav class="list-none mb-10">
                <li>
                  <a class="text-gray-600 hover:text-gray-800">hinamatsuri</a>
                </li>
                <li>
                  <a class="text-gray-600 hover:text-gray-800">meruko-chan</a>
                </li>
                <li>
                  <a class="text-gray-600 hover:text-gray-800">fate stay night</a>
                </li>
                <li>
                  <a class="text-gray-600 hover:text-gray-800">charlotte</a>
                </li>
              </nav>
            </div>
            <div class="lg:w-1/4 md:w-1/2 w-full px-4">
              <h2 class="title-font font-medium text-gray-900 tracking-widest text-sm mb-3">adventure</h2>
              <nav class="list-none mb-10">
                <li>
                  <a class="text-gray-600 hover:text-gray-800">one piece </a>
                </li>
                <li>
                  <a class="text-gray-600 hover:text-gray-800">naruto</a>
                </li>
                <li>
                  <a class="text-gray-600 hover:text-gray-800">fairy tail</a>
                </li>
                <li>
                  <a class="text-gray-600 hover:text-gray-800">hunterxhunter</a>
                </li>
              </nav>
            </div>
            <div class="lg:w-1/4 md:w-1/2 w-full px-4">
              <h2 class="title-font font-medium text-gray-900 tracking-widest text-sm mb-3">romance</h2>
              <nav class="list-none mb-10">
                <li>
                  <a class="text-gray-600 hover:text-gray-800">my dress up darling</a>
                </li>
                <li>
